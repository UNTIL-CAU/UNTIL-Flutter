              ...
              child: Container(
                ...
                child: ConstrainedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        setState(() {
                          _checkpoints.add(Data_Checkpoint(_checkpoints.length, '', '', widget.data));
                        });
                        Future.delayed(const Duration(milliseconds: 100), () {
                          if (_scrollController.position.maxScrollExtent > 0) {
                            _scrollController.animateTo(
                                _scrollController.position.maxScrollExtent + ITEM_HEIGHT,
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          if (value == null) {
                            ...
                            DateTime endDate = DateTime.parse(widget.data.task.endDate);
                            DateTime startDate = DateTime.parse(widget.data.task.startDate);
                            if (startDate.year > date.year || startDate.month > date.month || startDate.day > date.day ||
                                endDate.year < date.year || endDate.month < date.month || endDate.day < date.day) {
